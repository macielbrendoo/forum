...
public class TopicosController {
    ...
    @GetMapping
    public Page<TopicoDto> lista(@RequestParam(required = false) String nomeCurso, @PageableDefault(sort = "id", direction = Sort.Direction.ASC, size = 10) Pageable paginacao) {
        if (nomeCurso == null) {
